...
with_node \
  ...
  --target "/Users/timmydang/Desktop/RAGrecording/mobile/ios/Pods/Target Support Files/Pods-Tai/ExpoModulesProvider.swift" \
  --entitlement "/Users/timmydang/Desktop/RAGrecording/mobile/ios/Tai/Tai.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-document-picker" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-secure-store"
